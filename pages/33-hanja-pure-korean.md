...
한자어는 **중국어 단어가 한국어 발음으로 적응된 것**입니다. 오늘날 한글로 쓰이지만, 각 음절은 고유한 의미를 가진 한자에 대응합니다.
...
---
**학교 (學校)**學 + 校배울 학 + 학교 교school

---
**전화 (電話)**電 + 話번개 전(電氣) + 말 화telephone (electric talk)

---
**도서관 (圖書館)**圖 + 書 + 館그림 도 + 글 서 + 건물 관library (picture·book·hall)

---
**의사 (醫師)**醫 + 師의술 의 + 스승 사doctor (medicine master)

---
**음악 (音樂)**音 + 樂소리 음 + 즐길 락music (sound·joy)

---
**경제 (經濟)**經 + 濟다스릴 경 + 건널 제economy (manage·cross)

---
**문화 (文化)**文 + 化글 문 + 될 화culture (writing·become)

---
**사회 (社會)**社 + 會모일 사 + 모일 회society (gathering·gathering)

---
**철학 (哲學)**哲 + 學밝을 철 + 배울 학philosophy (wisdom·learning)

---
**국제 (國際)**國 + 際나라 국 + 사이 제international (nation·between)

---
**대학 (大學)**大 + 學클 대 + 배울 학university (great learning)

---
**병원 (病院)**病 + 院병 병 + 집 원hospital (illness house)
...
---
**學 학**배울 학학교(學校) · 학생(學生) · 학원(學院) · 대학(大學)

---
**校 교**학교 교학교(學校) · 교장(校長) · 교실(敎室)

---
**國 국**나라 국한국(韓國) · 국제(國際) · 국민(國民) · 외국(外國)

---
**語 어**말씀 어한국어(韓國語) · 영어(英語) · 언어(言語)

---
**人 인**사람 인한국인(韓國人) · 외국인(外國人) · 인간(人間)

---
**大 대**클 대대학(大學) · 대통령(大統領) · 대한민국(大韓民國)

---
**小 소**작을 소초등학교(初等學校) · 소설(小說) · 소수(小數)

---
**中 중**가운데 중중학교(中學校) · 중국(中國) · 중심(中心)

---
**高 고**높을 고고등학교(高等學校) · 고속(高速) · 고온(高溫)

---
**先 선**먼저 선선생(先生) · 선배(先輩) · 우선(優先)

---
**生 생**날 생 / 살 생학생(學生) · 선생(先生) · 생일(生日) · 생활(生活)

---
**日 일**날 일 / 해 일생일(生日) · 일본(日本) · 일요일(日曜日)

---
**月 월**달 월월요일(月曜日) · 월급(月給) · 세월(歲月)

---
**年 년/연**해 년년도(年度) · 작년(昨年) · 내년(來年) · 청년(靑年)

---
**水 수**물 수수영(水泳) · 수도(水道) · 홍수(洪水)

---
**火 화**불 화화요일(火曜日) · 화재(火災) · 화산(火山)

---
**山 산**뫼 산산(山) · 산업(産業) · 부산(釜山)

---
**心 심**마음 심심리(心理) · 관심(關心) · 중심(中心)

---
**力 력/역**힘 력능력(能力) · 노력(努力) · 매력(魅力)

---
**文 문**글 문문화(文化) · 문법(文法) · 작문(作文) · 문서(文書)

---
**化 화**될 화문화(文化) · 변화(變化) · 현대화(現代化)

---
**時 시**때 시시간(時間) · 시대(時代) · 동시(同時)

---
**間 간**사이 간시간(時間) · 인간(人間) · 공간(空間)

---
**長 장**길 장 / 어른 장교장(校長) · 성장(成長) · 장점(長點)

---
**電 전**번개 전전화(電話) · 전기(電氣) · 전자(電子)

---
**話 화**말씀 화전화(電話) · 대화(對話) · 회화(會話)

---
**愛 애**사랑 애애인(愛人) · 사랑(← 순우리말!) · 애정(愛情)

---
**情 정**뜻 정 / 정 정감정(感情) · 우정(友情) · 애정(愛情)

---
**友 우**벗 우친구(親舊) · 우정(友情) · 우방(友邦)

---
**家 가**집 가가족(家族) · 국가(國家) · 작가(作家) · 가정(家庭)
...
---
개념고유어 (Native)한자어 (Sino-Korean)뉘앙스 차이
...
---
sky**하늘** (poetic, emotional)천공 天空 (celestial, literary)하늘 always wins in daily life; 천공 = poetry

---
person**사람** (warm, human)인간 人間 (humanity, philosophical)사람 = that person; 인간 = humankind

---
name**이름** (everyday)성명 姓名 (formal, official)이름 = "What's your name?"; 성명 = official documents

---
heart/mind**마음** (deep, soulful)심리 心理 (psychology, academic)마음 = emotional heart; 심리 = mental state

---
number**하나/둘/셋** (native counting)일/이/삼 一二三 (Sino-Korean counting)Both systems used — different contexts!
...
---
**컴퓨터**computercomputer

---
**스마트폰**smartphonesmartphone (핸드폰 is also used)
...
---
**아파트**apartmentapartment building

---
**아이스크림**ice creamice cream

---
**인터넷**internetinternet

---
**콘텐츠**contentscontent (media)

---
**파이팅**fightingGo for it! / You've got this! (Korean usage)

---
**셀카**self + cameraselfie (Korean portmanteau)
...
---
하늘고유어 ✅Native Korean — no Chinese character origin, ancient word

---
학교한자어 ✅學校 — from Chinese, each syllable = one character

---
커피외래어 ✅From English "coffee" — phonetic transcription

---
사랑고유어 ✅Pure Korean — one of the oldest emotional words, no Hanja equivalent

---
병원한자어 ✅病院 — 병(illness) + 원(hall/institution)

---
아파트외래어 ✅From English "apartment" — transcribed phonetically

---
밥고유어 ✅Native Korean — rice/meal, fundamental daily word

---
문화한자어 ✅文化 — 문(writing) + 화(become/transform)
