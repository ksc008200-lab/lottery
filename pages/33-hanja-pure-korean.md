...
| **의사 (醫師)** | 醫 + 師 | 의술 의 + 스승 사 | doctor (medicine master) |
| **음악 (音樂)** | 音 + 樂 | 소리 음 + 즐길 락 | music (sound·joy) |
| **경제 (經濟)** | 經 + 濟 | 다스릴 경 + 건널 제 | economy (manage·cross) |
| **문화 (文化)** | 文 + 化 | 글 문 + 될 화 | culture (writing·become) |
| **사회 (社會)** | 社 + 會 | 모일 사 + 모일 회 | society (gathering·gathering) |
| **철학 (哲學)** | 哲 + 學 | 밝을 철 + 배울 학 | philosophy (wisdom·learning) |
...
| **語 어** | 말씀 어 | 한국어(韓國語) · 영어(英語) · 언어(言語) |
| **人 인** | 사람 인 | 한국인(韓國人) · 외국인(外國人) · 인간(人間) |
| **大 대** | 클 대 | 대학(大學) · 대통령(大統領) · 대한민국(大韓民國) |
| **小 소** | 작을 소 | 초등학교(初等學校) · 소설(小說) · 소수(小數) |
| **中 중** | 가운데 중 | 중학교(中學校) · 중국(中國) · 중심(中心) |
| **高 고** | 높을 고 | 고등학교(高等學校) · 고속(高速) · 고온(高溫) |
| **先 선** | 먼저 선 | 선생(先生) · 선배(先輩) · 우선(優先) |
| **生 생** | 날 생 / 살 생 | 학생(學生) · 선생(先生) · 생일(生日) · 생활(生活) |
| **日 일** | 날 일 / 해 일 | 생일(生日) · 일본(日本) · 일요일(日曜日) |
| **月 월** | 달 월 | 월요일(月曜日) · 월급(月給) · 세월(歲月) |
| **年 년/연** | 해 년 | 년도(年度) · 작년(昨年) · 내년(來年) · 청년(靑年) |
| **水 수** | 물 수 | 수영(水泳) · 수도(水道) · 홍수(洪水) |
| **火 화** | 불 화 | 화요일(火曜日) · 화재(火災) · 화산(火山) |
| **山 산** | 뫼 산 | 산(山) · 산업(産業) · 부산(釜山) |
| **心 심** | 마음 심 | 심리(心理) · 관심(關心) · 중심(中心) |
| **力 력/역** | 힘 력 | 능력(能力) · 노력(努力) · 매력(魅力) |
| **文 문** | 글 문 | 문화(文化) · 문법(文法) · 작문(作文) · 문서(文書) |
| **化 화** | 될 화 | 문화(文化) · 변화(變化) · 현대화(現代化) |
| **時 시** | 때 시 | 시간(時間) · 시대(時代) · 동시(同時) |
| **間 간** | 사이 간 | 시간(時間) · 인간(人間) · 공간(空間) |
| **長 장** | 길 장 / 어른 장 | 교장(校長) · 성장(成長) · 장점(長點) |
| **電 전** | 번개 전 | 전화(電話) · 전기(電氣) · 전자(電子) |
| **話 화** | 말씀 화 | 전화(電話) · 대화(對話) · 회화(會話) |
| **愛 애** | 사랑 애 | 애인(愛人) · 사랑(← 순우리말!) · 애정(愛情) |
...
| **커피** | coffee | coffee |
| **버스** | bus | bus |
| **아파트** | apartment | apartment building |
...
| 사랑 | 고유어 ✅ | Pure Korean — one of the oldest emotional words, no Hanja equivalent |
| 병원 | 한자어 ✅ | 病院 — 병(illness) + 원(hall/institution) |
